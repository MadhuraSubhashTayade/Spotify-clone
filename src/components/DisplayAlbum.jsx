...
const DisplayAlbum = () => {
  const { id } = useParams();
  const albumData = albumsData.find((x) => x.id == id);

  return (
    <>
      {/* We have to display navBar on all the views. That's why it is included in both DisplayHome and DisplayAlbum as well */}
      <Navbar />
      <div className="mt-10 flex gap-8 flex-col md:flex-row md:items-end">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-1">
            ...
            />
            <b>Spotify </b>- 1,32424,234 likes - <b>50 songs, </b>
            about 2 hr 30 min
          </p>
        </div>
      </div>
